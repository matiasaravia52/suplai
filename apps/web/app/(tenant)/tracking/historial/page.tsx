...
export default async function HistorialPage({
  ...
  return (
    <div className="p-6">
      ...
      {visits.length === 0 ? (
        <p className="text-gray-500 text-sm">No hay visitas en el período seleccionado.</p>
      ) : (
                ...
                return (
                  <tr key={v.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 text-gray-600">
                      {v.checkout_at ? new Date(v.checkout_at).toLocaleString("es-AR") : <span className="text-yellow-600">En curso</span>}
                    </td>
                    <td className="px-4 py-3 text-gray-600">
